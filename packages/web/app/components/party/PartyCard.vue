      ...
      <div class="flex items-start gap-2 sm:gap-3">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-1.5 sm:gap-2 mb-1">
            <CardTitle
              class="text-sm sm:text-base font-bold truncate group-hover:text-primary transition-colors"
            >
              {{ party.name }}
            </CardTitle>
            <Crown
          ...
          <CardDescription
            class="text-xs flex items-center gap-1 sm:gap-1.5 flex-wrap"
            role="status"
          >
      ...
      <div class="flex items-center justify-between gap-2 pt-2 sm:pt-3 border-t border-border/50">
        <div class="flex -space-x-2 flex-1 min-w-0" role="list" aria-label="Miembros de la party">
          ...
          >
            ...
            />
            <AvatarFallback
              class="text-[10px] sm:text-xs bg-linear-to-br from-primary/20 to-accent/20"
            >
              {{
