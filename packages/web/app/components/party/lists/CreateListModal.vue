      ...
      <div class="space-y-6 py-4">
        <div class="space-y-2">
          ...
          <Input
            id="list-name"
            v-model="name"
            placeholder="Ej: Animes de Temporada, Tier List de Waifus..."
            maxlength="50"
            aria-required="true"
            aria-describedby="list-name-helper"
            autofocus
          ...
          >
            <div>
              ...
              <Label
                ...
                role="radio"
                :aria-checked="type === 'anime'"
                aria-label="Lista de anime compartida"
              >
            ...
            <div>
              ...
              <Label
                ...
                class="flex flex-col items-center justify-center rounded-md border-2 border-muted bg-transparent p-4 sm:p-6 hover:bg-muted/50 peer-data-[state=checked]:border-primary peer-data-[state=checked]:bg-primary/10 peer-data-[state=checked]:text-primary cursor-pointer transition-all duration-200 min-h-[100px] sm:min-h-[120px]"
                role="radio"
                :aria-checked="type === 'tier_list'"
                aria-label="Tier list colaborativa"
              >
