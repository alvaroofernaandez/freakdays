...
<template>
  <div class="space-y-4 sm:space-y-6" role="main" aria-label="Editor de Tier List">
        ...
        <div class="flex-1 min-w-0">
          <div class="flex items-center gap-2">
            ...
            <Input
              ...
              aria-label="Nombre de la tier list"
            />
          </div>
    ...
    <!-- Tiers -->
    <div
      class="space-y-1 bg-background rounded-lg overflow-hidden border shadow-sm"
      role="region"
    ...
    >
      ...
      >
        ...
        >
          <div class="flex-1 min-w-0">
            <Input
              ...
              placeholder="Nombre"
              :aria-label="`Nombre del tier ${tier.name}`"
            />
          </div>
          <!-- Tier Controls -->
        ...
        <!-- Drop Zone -->
        <div
          class="flex-1 bg-muted/20 p-3 sm:p-2 min-h-[80px]"
          role="region"
        ...
        >
          ...
          >
            <template #item="{ element }">
              ...
              >
                <span class="pr-7 sm:pr-6 block text-sm font-medium wrap-break-word">{{
                  element.content
                }}</span>
                <button
            ...
            <template #empty>
              <div
                class="flex items-center justify-center h-full min-h-[60px] text-xs text-muted-foreground italic"
                role="status"
              >
                Arrastra items aquí
              </div>
    ...
    <!-- Pool Section -->
    <div
      class="bg-card border rounded-lg p-4 sm:p-5 space-y-4 shadow-sm"
      role="region"
    ...
    >
      <div class="flex items-center justify-between">
        ...
        <span
          class="text-xs sm:text-sm text-muted-foreground bg-muted px-2.5 py-1 rounded-full font-medium"
          role="status"
          :aria-label="`${pool.length} items sin clasificar`"
        >
          {{ pool.length }}
        </span>
      </div>
      ...
      <div class="flex flex-col sm:flex-row gap-2" role="group" aria-label="Añadir nuevo item">
        <div class="flex-1 space-y-1.5">
          ...
          <Input
            ...
            maxlength="100"
            aria-describedby="new-item-helper"
    ...
    >
      ...
      <div>
        ...
        <p class="text-sm text-muted-foreground mt-1">
          Añade items usando el campo de arriba para empezar
        </p>
      </div>
    </div>
  </div>
