...
<template>
  <div
    ...
    :class="[
      ...
      !isDragging &&
        !isDraggingLocal &&
        'hover:opacity-90 hover:shadow-md focus-within:opacity-90 focus-within:shadow-md active:opacity-95',
    ]"
    :style="
    ...
    @keydown.enter.prevent="handleDragStartKeyboard"
