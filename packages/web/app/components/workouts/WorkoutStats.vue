...
import { Flame, Calendar, Timer } from 'lucide-vue-next';
...
<template>
  <div class="grid grid-cols-3 gap-2 sm:gap-3">
    ...
    <Card
      class="group relative overflow-hidden border-exp-hard/30 bg-gradient-to-br from-exp-hard/15 via-exp-hard/10 to-exp-hard/5 hover:border-exp-hard/50 hover:shadow-md hover:shadow-exp-hard/10 transition-all duration-300"
    >
      <div
        class="absolute inset-0 bg-gradient-to-br from-exp-hard/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"
      />
      <div
        class="absolute top-0 right-0 w-20 h-20 bg-exp-hard/10 rounded-full blur-2xl opacity-40 group-hover:opacity-60 transition-opacity duration-300"
      />
      <CardContent class="relative text-center py-3 sm:py-4 px-2 sm:px-3">
        <div class="flex flex-col items-center gap-1.5 sm:gap-2">
          <div
            class="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-exp-hard/20 backdrop-blur-sm border border-exp-hard/30 flex items-center justify-center group-hover:scale-110 group-hover:bg-exp-hard/30 transition-all duration-300"
          >
            <Flame class="h-4 w-4 sm:h-5 sm:w-5 text-exp-hard" />
          </div>
          <div class="text-xl sm:text-2xl font-bold text-exp-hard leading-none">
            {{ totalCount }}
          </div>
          <div
            class="text-[10px] sm:text-xs text-muted-foreground/90 font-medium uppercase tracking-wide"
    ...
    >
      ...
      <CardContent class="relative text-center py-3 sm:py-4 px-2 sm:px-3">
        <div class="flex flex-col items-center gap-1.5 sm:gap-2">
          ...
          >
            <Timer class="h-4 w-4 sm:h-5 sm:w-5 text-exp-easy" />
          </div>
