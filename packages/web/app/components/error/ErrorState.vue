...
<template>
  <Card v-if="variant === 'default'" class="border-destructive/20 glass relative overflow-hidden">
    ...
    <div
      class="absolute top-0 left-0 w-full h-0.5 bg-linear-to-r from-destructive via-primary to-accent"
    />
    ...
    <CardHeader class="relative z-10">
      <div class="flex items-center gap-3">
        <div class="relative">
          <div
            class="absolute -inset-2 bg-destructive/20 blur-xl rounded-full animate-pulse opacity-50"
            style="animation-duration: 2s"
          />
          <div
            class="relative p-2.5 rounded-full bg-destructive/10 border border-destructive/20 backdrop-blur-sm"
          >
  ...
  <div v-else class="flex flex-col items-center justify-center p-8 text-center relative">
    <div
      class="absolute inset-0 bg-destructive/5 rounded-lg border border-destructive/20 backdrop-blur-sm"
    />
    <div class="relative z-10">
      <div class="relative inline-flex items-center justify-center mb-4">
        <div
          class="absolute -inset-3 bg-destructive/20 blur-xl rounded-full animate-pulse opacity-50"
          style="animation-duration: 2s"
        />
        <div
          class="relative p-3 rounded-full bg-destructive/10 border border-destructive/20 backdrop-blur-sm"
        >
