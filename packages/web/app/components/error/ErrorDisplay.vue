  ...
  <Card :class="['border relative overflow-hidden glass', severityConfig.borderColor]">
    ...
    <div
      :class="[
        ...
        severity === 'error'
          ? 'bg-linear-to-r from-destructive via-primary to-accent'
          : severity === 'warning'
            ? 'bg-linear-to-r from-exp-medium via-accent to-primary'
    ...
    <CardHeader class="relative z-10">
      <div class="flex items-start gap-3">
        <div class="relative">
          <div
            :class="['absolute -inset-2 blur-xl opacity-50 animate-pulse', severityConfig.bgColor]"
            style="animation-duration: 2s"
          />
          <div
            :class="[
              'relative p-2.5 rounded-full border backdrop-blur-sm',
    ...
    <CardContent v-if="details || $slots.default" class="space-y-4 relative z-10">
      <div
        v-if="details && showDetailsState"
        class="p-3 rounded-lg bg-muted/50 border backdrop-blur-sm relative overflow-hidden"
