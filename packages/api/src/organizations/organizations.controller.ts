...
export class OrganizationsController {
  ...
  @Get('me')
  myOrganizations(@Req() request: Request): Promise<OrganizationMembershipSummary[]> {
  ...
  bootstrapPersonalOrganization(@Req() request: Request): Promise<OrganizationMembershipSummary> {
    const user = this.getRequestUser(request);
